...
DECHLD:
  ...
  CLRF      TMR1H
  BANKSEL   SRV_TICKS
#define SERVO_DESFASE ((SERVO_ACUAL_MINDUTY_US-TMR2_SERVO_MINDUTY_US)*SERVO_RANGE_DEGS)/(SERVO_RANGE_US)
  MOVLW     HIGH(SERVO_RANGE_DEGS+SERVO_DESFASE-SERVO_OVERSHT_COMPS)
  MOVLW     LOW(SERVO_RANGE_DEGS+SERVO_DESFASE-SERVO_OVERSHT_COMPS)
  MOVWF     SRV_TICKS
  BANKSEL   T1CON
  BSF       T1CON,      TMR1ON
#endif
