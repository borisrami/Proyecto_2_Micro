...
- `0x00`: `ACK(0)`
  ...
  - La secuencia es `0xAA 0x88 0x0B 0x16 0xB0 0x55`.
- `0xFF`: `HUNGUP(0)`
...
- `0x01`: `TIMEOUT(2, 1, MS)`
  ...
  - Una vez ocurrido, como mínimo, `MS` milisegundos desde el último byte, y el comando no esté completad, el dispositivo esclavo descartará la información recibida.
